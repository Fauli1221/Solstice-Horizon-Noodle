document.addEventListener("DOMContentLoaded", function (event) {
    ...
    const googlyNormalElement = document.getElementById("googly-state").getElementsByTagName('*')[1];
    const googlyWrongElement = document.getElementById("googly-state-gif").getElementsByTagName('*')[1];
    const googlyWokeElement = document.getElementById("googly-state-woke").getElementsByTagName('*')[1];
    let isPoked = false;
    let isWoked = false;
